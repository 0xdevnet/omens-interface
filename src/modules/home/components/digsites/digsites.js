      ...
      <div className={`${Style.mainContainer}  `}>
        ...
        <div className="mt-5">
          <p className={Style.paragraph}>
            BAD OMENS. GOOD OMENS. LIFE IS FULL OF THEM. PERHAPS, YOU COULD
            CONTROL THESE OMENS? INFLUENCE THE FATE OF YOURSELF? OTHERS? THE
            WORLD?
          </p>
          <p className={Style.paragraph}>
            TAKE CONTROL. UNLEASH YOUR INNER BEAST. NO ONE SHOULD BRAVE THE
            UNDERWORLD ALONE.
          </p>
        </div>
      </div>
